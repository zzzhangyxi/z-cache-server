 ...
 */
package com.zhang.cache.dataplane.event;
 ...
 */
@Component
public class DataPlaneEventExecutorRegister {
    ...
    public void initExecutor() {
        EventPublisher.registerExecutor(DataPlaneEventType.READ_KEY, READ_KEY_EVENT_POOL);
        EventPublisher.registerExecutor(DataPlaneEventType.WRITE_KEY, WRITE_KEY_EVENT_POOL);
    }
}
